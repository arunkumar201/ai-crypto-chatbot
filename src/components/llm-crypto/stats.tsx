import { ActivityIcon,CoinsIcon,DollarSignIcon,GaugeIcon,TrendingUpIcon,UsersIcon } from "lucide-react";
			...
			<CardContent className="grid gap-6 p-6">
				<div className="grid grid-cols-2 gap-4">
					<div className="flex flex-col gap-1">
						...
						<div className="text-lg font-medium">${formatValue(marketCap)}</div>
					</div>
					<div className="flex flex-col gap-1">
						<div className="text-sm text-gray-500 dark:text-gray-400">
						...
						<div className="text-lg font-medium">${formatValue(volume)}</div>
					</div>
				</div>
				<div className="grid grid-cols-2 gap-4">
					<div className="flex flex-col gap-1">
				...
				<div className="grid grid-cols-2 gap-4">
					<div className="flex flex-col gap-1">
						...
						<div className="text-lg font-medium">{formatValue(totalSupply)}</div>
					</div>
					<div className="flex flex-col gap-1">
						<div className="text-sm text-gray-500 dark:text-gray-400">
